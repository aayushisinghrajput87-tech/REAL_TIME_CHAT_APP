...
const Navbar = () => {
  ...
  /*  const queryClient=useQueryClient();
    ...
    return (<nav className="bg-base-200 border-b border-base-300 flex items-center h-16 z-30 top-0 sticky">
              ...
              {/*LOGO -ONLY IN THE CHAT PAGE*/}
                ...
                <div className="avatar">
                    <div className="w-9 rounded-full">
                        <img src={authUser?.profilePic || "https://placehold.co/100x100?text=Profile+Pic"} alt="User Avatar" rel="noreferrer"/>
                    </div>
                </div>

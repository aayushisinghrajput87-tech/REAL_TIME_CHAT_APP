...
//This is how we did it using our custom hook-optimized versions
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className=" form-control w-full">
                  ...
                  <input type="password" placeholder="Create a password" className="input input-bordered w-full" value={signupData.password} onChange={(e) => setSignupData({ ...signupData, password: e.target.value })} required />

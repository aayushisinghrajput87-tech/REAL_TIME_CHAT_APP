...
const NotificationsPage = () => {
    ...
    const incomingRequests = friendRequests && Array.isArray(friendRequests.incomingReqs)
        ? friendRequests.incomingReqs
        : [];
    const acceptedRequests = friendRequests && Array.isArray(friendRequests.acceptedReqs)
            ...
            <div className="container mx-auto max-w-4xl space-y-8">
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center py-12 text-error">
                        <span className="font-bold">Failed to load notifications.</span>
                        <span>{error.message || "Unknown error"}</span>
                    </div>
                ) : !friendRequests ? (
                    <div className="flex flex-col items-center py-12 text-error">
                        <span className="font-bold">No notifications data received.</span>
                    </div>
                ) : (
                    <>
                                        ...
                                        <div key={req._id} className="card bg-base-200 shadow-sm hover:shadow-md transition-shadow">
                                            <div className="card-body p-4">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <button className="btn btn-primary btn-sm" onClick={() => acceptRequestMutation(req._id)} disabled={isPending}>Accept</button>
